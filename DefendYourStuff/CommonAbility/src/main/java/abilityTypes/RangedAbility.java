...
public class RangedAbility extends Ability {
    ...
    public RangedAbility(DamageRange damageRange, String imageURL, Dimension dimension, Position pos, CollisionType collisionType, EffectContainer effectContainer, Ability... ab) {
