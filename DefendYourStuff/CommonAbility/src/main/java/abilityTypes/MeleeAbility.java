...
public class MeleeAbility extends Ability {
    ...
    public MeleeAbility(DamageRange damageRange, String imageURL, Dimension dimension, Position pos, CollisionType collisionType, EffectContainer effectContainer, Ability... ab) {
